...
Check mails [in the local phoenix mailbox](http://localhost:4000/dev/mailbox/).
...
* [x] print ticket feature [Story](.agent/tasks/004_Print_Tickets.md)
* [x] allocation endpoint [Story](.agent/tasks/003_Make-Allocation.md)
